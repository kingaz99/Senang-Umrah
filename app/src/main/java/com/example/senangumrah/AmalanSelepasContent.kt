...
import kotlinx.android.synthetic.main.activity_amalan_selepas_content.*
import kotlinx.android.synthetic.main.activity_amalan_semasa_home.*
import kotlinx.android.synthetic.main.cover_content_amalan_selepas.*
...
class AmalanSelepasContent : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.cover_content_amalan_selepas)
        ...
        videoView = findViewById<View>(R.id.videoAmalanSelepas) as VideoView?
    ...
    private fun onSetNavigationDrawerEvents() {
        navigation_button_amalan_selepas_content.setOnClickListener(this)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.navigation_button_amalan_selepas_content -> {
                amalanselepascontentDrawerLayout.openDrawer(navigationView, true)
            }
            R.id.ll_First -> {
                ...
                button.setOnClickListener{
                    ...
                    startActivity(intent)
                    amalanselepascontentDrawerLayout.closeDrawer(navigationView, true)
                }
            }
            R.id.ll_Second -> {
            ...
            R.id.close -> {
                showToast("Amalan Selepas Umrah COntent Home")
                amalanselepascontentDrawerLayout.closeDrawer(navigationView, true)
            }
            else -> {
                showToast("Amalan Selepas Content Umrah Home")
                amalanselepascontentDrawerLayout.closeDrawer(navigationView, true)
            }
        }
    }
    ...
    override fun onBackPressed() {
        if ( amalanselepascontentDrawerLayout.isDrawerOpen(navigationView)) {
            amalanselepascontentDrawerLayout.closeDrawer(navigationView, true)
        } else {
            super.onBackPressed()
        }
