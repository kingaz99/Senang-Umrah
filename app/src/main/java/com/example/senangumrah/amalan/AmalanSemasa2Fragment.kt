...
class AmalanSemasa2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa2, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa2) as VideoView
        video.requestFocus()
