...
class AmalanSemasa5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa5, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa5) as VideoView
        video.requestFocus()
