...
class AmalanSemasa4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa4, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa4) as VideoView
        video.requestFocus()
