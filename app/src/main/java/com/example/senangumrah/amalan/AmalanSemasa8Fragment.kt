...
class AmalanSemasa8Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa8, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa8) as VideoView
        video.requestFocus()
