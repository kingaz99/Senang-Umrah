...
class AmalanSemasa3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa3, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa3) as VideoView
        video.requestFocus()
