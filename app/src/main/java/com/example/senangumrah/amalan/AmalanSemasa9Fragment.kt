...
class AmalanSemasa9Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa9, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa9) as VideoView
        video.requestFocus()
