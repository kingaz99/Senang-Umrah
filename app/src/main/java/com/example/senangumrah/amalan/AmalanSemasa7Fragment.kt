...
class AmalanSemasa7Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa7, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa7) as VideoView
        video.requestFocus()
