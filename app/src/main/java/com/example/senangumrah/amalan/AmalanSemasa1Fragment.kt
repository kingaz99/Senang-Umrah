...
class AmalanSemasa1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_amalan_semasa1, container, false)
        val video = rootView.findViewById<View>(R.id.videoAmalanSemasa1) as VideoView
        video.requestFocus()
