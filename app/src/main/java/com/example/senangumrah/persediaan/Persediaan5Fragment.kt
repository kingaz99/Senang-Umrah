...
class Persediaan5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_persediaan5, container, false)
        val video = rootView.findViewById<View>(R.id.videoPersediaan5) as VideoView
        video.requestFocus()
